...
namespace Keboola\DockerLGRBundle\RWrapper;
...
class RWrapper
{
     ...
     * @param array $credentials Array of database credentilas
     */
    ...
    {
        $this->logger->info("Attempting to run script $scriptFileName");
        ...
        $commandLine =
            ...
            $scriptFileName . " " . // Actual R module which we want to run
